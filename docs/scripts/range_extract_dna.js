...
function writeRanges(sequence) {
  ...
  if (this.type == "new_sequence") {
    ...
    if (this.strand == "reverse") {
      outputWindow.document.write(
        addReturns(reverse(complement(sequenceArray.join("")))) + "\n\n"
      );
    } else {
    ...
    for (var i = 0; i < this.ranges.length; i++) {
      if (this.ranges[i].getSequence(sequence) != "") {
        ...
        if (this.strand == "reverse") {
          outputWindow.document.write(
            reverse(
              complement(addReturns(this.ranges[i].getSequence(sequence)))
            ) + "\n\n"
          );
        } else {
          outputWindow.document.write(
  ...
  if (this.type == "uppercased") {
    ...
    if (this.strand == "reverse") {
      outputWindow.document.write(
        reverse(complement(addReturns(sequence))) + "\n\n"
      );
    } else {
  ...
  if (this.type == "preserved") {
    ...
    if (this.strand == "reverse") {
      outputWindow.document.write(
        reverse(complement(addReturns(randomSequence))) + "\n\n"
      );
    } else {
