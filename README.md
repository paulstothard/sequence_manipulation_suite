...
> **New version available:** Sequence Manipulation Suite 3 (SMS3) is available at [https://paulstothard.github.io/sequence-manipulation-suite/](https://paulstothard.github.io/sequence-manipulation-suite/). SMS3 is a local-first browser toolkit with updated sequence, protein, table, plot, viewer, and workflow tools.
